...
class Downloader:
	...
	def __init__(self, models_path = pavimentados_path / 'models' ):
		"""
		This class allows user to download the models and other model data from the Inter-American Development Bank repositories
		
		Parameters
		----------

		models_path: str (default instalation path of package)
			The route to download and check the artifacts of the models
		"""
	...
	def check_files(self, filePath):
		...
		"""
		This function allows to check if an specific file exists
