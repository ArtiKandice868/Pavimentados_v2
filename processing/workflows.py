from pavimentados2.analyzers.gps_sources import GPS_Data_Loader
from pavimentados2.analyzers.calculators import Results_Calculator as calculator
from pavimentados2.processing.sources import Image_Source_Loader
...
class Workflow_Processor:
    def __init__(self, images_input, **kwargs):
        ...
        gps_sections_distance = kwargs.get('gps_sections_distance', 100) #can change the section distance for the summary table here
