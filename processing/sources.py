...
class ListImages:
    ...
    def get_section(self, idx_initial, idx_final):
        return self.images[idx_initial:idx_final]
    
    def get_batch(self, idx_initial, batch_size = 8):
        return self.get_section(idx_initial, idx_initial+batch_size)
...
class ListRoutesImages:
    ...
    def get_section(self, idx_initial, idx_final):
        return self.routes[idx_initial:idx_final]
    
    def get_batch(self, idx_initial, batch_size = 8):
        return np.array([cv2.imread(str(img_path)) for img_path in self.get_section(idx_initial,idx_initial+batch_size)])
